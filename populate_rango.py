...
def populate():
    ...
    python_pages = [
        {'title': 'Official Python Tutorial', 'url':'http://docs.python.org/3/tutorial/', 'views': 76},
        {'title':'How to Think like a Computer Scientist', 'url':'http://www.greenteapress.com/thinkpython/', 'views': 54},
        {'title':'Learn Python in 10 Minutes', 'url':'http://www.korokithakis.net/tutorials/python/', 'views': 87} ]
    ...
    other_pages = [
        ...
        {'title':'Flask', 'url':'http://flask.pocoo.org', 'views': 91,} ]
